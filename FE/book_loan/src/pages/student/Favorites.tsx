      ...
      {isLoading ? (
        ...
        <section className="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {books.map((book) => (
            <article
              key={book.id}
              className="group overflow-hidden rounded-xl border border-surface-container bg-surface-bright scholar-shadow"
            >
              <button
                type="button"
              ...
              <div className="space-y-2 md:space-y-4 p-3 md:p-5">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <button
                    ...
                    className="flex h-8 w-8 md:h-10 md:w-10 shrink-0 items-center justify-center rounded-lg border border-surface-container-high text-error transition-colors hover:bg-red-50 disabled:cursor-wait disabled:opacity-60"
                  >
