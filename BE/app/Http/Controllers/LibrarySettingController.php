...
class LibrarySettingController extends Controller
{
    ...
    public function update(LibrarySettingUpdateRequest $request)
    {
        ...
        $settings->fill([
            ...
            'room_max_hours_per_week' => $validated['room_max_hours_per_week'],
    ...
    private function formatResponse(LibrarySetting $settings): array
    {
        return [
            ...
            'room_max_hours_per_week' => (int) ($settings->room_max_hours_per_week ?? LibrarySetting::DEFAULT_ROOM_MAX_HOURS_PER_WEEK),
